...
library KswapLibrary {
    ...
    function getReserves(
        ...
        (uint256 reserve0, uint256 reserve1, ) = IKswapPair(pairFor(factory, tokenA, tokenB)).getReserves();
    ...
    function quote(
        ...
        require(reserveA > 0 && reserveB > 0, "KswapLibrary: INSUFFICIENT_LIQUIDITY");
    ...
    function getAmountOut(
        ...
        require(reserveIn > 0 && reserveOut > 0, "KswapLibrary: INSUFFICIENT_LIQUIDITY");
